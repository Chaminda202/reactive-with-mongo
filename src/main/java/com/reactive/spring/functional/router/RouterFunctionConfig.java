...
import com.reactive.spring.functional.handler.SimpleHandlerFunction;
...
public class RouterFunctionConfig {
    @Bean
    public RouterFunction<ServerResponse> routerFunction(SimpleHandlerFunction simpleHandlerFunction) {
